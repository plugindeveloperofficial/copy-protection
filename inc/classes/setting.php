 ...
 * @since 1.0.0
 */
namespace Easy_Content_Protector\Inc\classes;
abstract class Setting{
    ...
    public function fields(){
        ...
        $fields = array(
            'heading' => esc_html__( 'Page Heading', 'easy-content-protector' ),
            'title' => esc_html__( 'Section Title', 'easy-content-protector' ),
            'menu' => esc_html__( 'Menu Name', 'easy-content-protector' ),
            'slug' => 'easy-content-protector',
            'settings' => array(
                array(
                    'name' => 'easy_content_protector',
                    'option' => 'easy_content_protector',
                    'title' => esc_html__( 'Title', 'easy-content-protector' ),
                    'description' => esc_html__( 'Description', 'easy-content-protector' ),
                    'fields' => array(
                        array(
                            'name' => 'setting_field_name',
                            'default' => esc_html__( 'Default Value.', 'easy-content-protector' ),
                            'title' => esc_html__( 'Field Name', 'easy-content-protector' ),
                            'type' => 'text',
                        )
                    )
                )
    ...
    public function register(){
        ...
        if($settings){
            ...
            foreach($settings as $group){
                ...
                $easy_content_protector['section_description'] = $section_description;
    ...
    public function description(){
        ...
        global $easy_content_protector;
        $description = isset($easy_content_protector['description']) ? $easy_content_protector['description'] : '';
        if($description){
